...
int Object3D::registerObject() {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(Object3DVertix) * numVertices, vertices, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(Object3DVertix), (void *)0);
    glEnableVertexAttribArray(0);

    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(Object3DVertix), (void *)(sizeof(glm::vec3)));
    glEnableVertexAttribArray(1);
    
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(Object3DVertix), (void *)(sizeof(glm::vec3) * 2));
...
int Object3D::load(const std::string &path) {
    ...
    std::vector<Object3DVertix> vertices;
        ...
        if (line.compare(0, 2, "v ") == 0) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                auto calcNorv = [&vertices, &defNorBit]() {
                    Object3DVertix &a = vertices[vertices.size() - 3], &b = vertices[vertices.size() - 2], &c = vertices[vertices.size() - 1];
